            ...
            {user && (
                <>
                    <div className="flex flex-col items-center justify-center gap-8 my-12">
                        <Analytics user={user} openNew={openNew} openEdit={openEdit} deleteStatus={deleteStatus} />
                        <CategoryList user={user} setOpenEdit={setOpenEdit} setDeleteStatus={setDeleteStatus} openNew={openNew} openEdit={openEdit} deleteStatus={deleteStatus} />
                    </div>
